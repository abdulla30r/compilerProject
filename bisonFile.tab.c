...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_headerName = 9,                 /* headerName  */
  YYSYMBOL_varName = 10,                   /* varName  */
  YYSYMBOL_number = 11,                    /* number  */
  YYSYMBOL_numberd = 12,                   /* numberd  */
  YYSYMBOL_13_ = 13,                       /* '+'  */
  YYSYMBOL_14_ = 14,                       /* '-'  */
  YYSYMBOL_15_ = 15,                       /* '/'  */
  YYSYMBOL_16_ = 16,                       /* '*'  */
  ...
  YYSYMBOL_headers = 21,                   /* headers  */
  YYSYMBOL_header = 22,                    /* header  */
  YYSYMBOL_program = 23,                   /* program  */
  YYSYMBOL_statements = 24,                /* statements  */
  YYSYMBOL_statement = 25,                 /* statement  */
  YYSYMBOL_expr = 26,                      /* expr  */
  YYSYMBOL_val = 27,                       /* val  */
  YYSYMBOL_multiVariable = 28,             /* multiVariable  */
  YYSYMBOL_dataType = 29,                  /* dataType  */
  YYSYMBOL_varNames = 30,                  /* varNames  */
  YYSYMBOL_oneVar = 31,                    /* oneVar  */
  YYSYMBOL_variableValueAssign = 32        /* variableValueAssign  */
};
...
{
       0,    86,    86,    88,    89,    91,    93,    94,    96,    97,
      99,   100,   101,   102,   104,   105,   106,   107,   108,   110,
     111,   112,   126,   128,   129,   131,   132,   134,   150,   164,
     180,   195,   211
};
#endif
...
static const char *const yytname[] =
{
  ...
  "comment", "purno", "EOL", "vogno", "eval", "headerName", "varName",
  "number", "numberd", "'+'", "'-'", "'/'", "'*'", "','", "'='", "$accept",
  "input", "headers", "header", "program", "statements", "statement",
...
{
       1,    23,     8,    26,     1,   -10,   -10,   -10,   -10,   -10,
      -9,    -8,   -10,   -10,    26,   -10,    25,   -10,   -10,   -10,
     -10,   -10,    -1,   -10,    11,   -10,    19,   -10,    -6,   -10,
      -9,    -9,    -9,    -9,    32,    33,     3,    -5,   -10,    25,
...
{
       0,     0,     0,     6,     4,     5,     1,    10,    23,    24,
       0,     0,     2,     7,     9,    11,     0,    12,     3,    21,
      19,    20,     0,    14,     0,     8,    27,    22,     0,    13,
       0,     0,     0,     0,    19,    20,     0,     0,    26,     0,
      15,    16,    18,    17,    30,    31,    32,    28,    29,    25
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -10,   -10,    36,   -10,   -10,    27,   -10,    -4,   -10,   -10,
     -10,     4,   -10,   -10
};
...
{
      38,    19,    20,    21,     1,    29,    47,    48,     6,    46,
      24,    39,    30,    31,    32,    33,    30,    31,    32,    33,
      36,    19,    34,    35,    32,    33,    40,    41,    42,    43,
       7,     8,     5,     9,    10,    26,    11,    37,    44,    45,
      18,    25,     0,    49
};

static const yytype_int8 yycheck[] =
{
       6,    10,    11,    12,     3,     6,    11,    12,     0,     6,
      18,    17,    13,    14,    15,    16,    13,    14,    15,    16,
      24,    10,    11,    12,    15,    16,    30,    31,    32,    33,
       4,     5,     9,     7,     8,    10,    10,    18,     6,     6,
       4,    14,    -1,    39
};
...
{
       0,     3,    20,    21,    22,     9,     0,     4,     5,     7,
       8,    10,    23,    24,    25,    28,    29,    32,    21,    10,
      11,    12,    26,    27,    18,    24,    10,    30,    31,     6,
      13,    14,    15,    16,    11,    12,    26,    18,     6,    17,
      26,    26,    26,    26,     6,     6,     6,    11,    12,    30
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* header: headerStart headerName  */
#line 91 "bisonFile.y"
                               {{printf("Included: %s\n",(yyvsp[0].txt));}}
#line 1179 "bisonFile.tab.c"
    break;

  case 10: /* statement: comment  */
#line 99 "bisonFile.y"
                   {printf("This is a comment\n");}
#line 1185 "bisonFile.tab.c"
    break;

  case 13: /* statement: eval expr EOL  */
#line 102 "bisonFile.y"
                        {printf("Evaluated result is : %f\n",(yyvsp[-1].numd));}
#line 1191 "bisonFile.tab.c"
    break;

  case 14: /* expr: val  */
#line 104 "bisonFile.y"
          {(yyval.numd) = (yyvsp[0].numd);}
#line 1197 "bisonFile.tab.c"
    break;

  case 15: /* expr: expr '+' expr  */
#line 105 "bisonFile.y"
                    {(yyval.numd) = (yyvsp[-2].numd) + (yyvsp[0].numd);}
#line 1203 "bisonFile.tab.c"
    break;

  case 16: /* expr: expr '-' expr  */
#line 106 "bisonFile.y"
                    {(yyval.numd) = (yyvsp[-2].numd) - (yyvsp[0].numd);}
#line 1209 "bisonFile.tab.c"
    break;

  case 17: /* expr: expr '*' expr  */
#line 107 "bisonFile.y"
                    {(yyval.numd) = (yyvsp[-2].numd) * (yyvsp[0].numd);}
#line 1215 "bisonFile.tab.c"
    break;

  case 18: /* expr: expr '/' expr  */
#line 108 "bisonFile.y"
                    {(yyval.numd) = (yyvsp[-2].numd) / (yyvsp[0].numd);}
#line 1221 "bisonFile.tab.c"
    break;

  case 19: /* val: number  */
#line 110 "bisonFile.y"
            {(yyval.numd) = (yyvsp[0].num)*1.0;}
#line 1227 "bisonFile.tab.c"
    break;

  case 20: /* val: numberd  */
#line 111 "bisonFile.y"
              {(yyval.numd) = (yyvsp[0].numd);}
#line 1233 "bisonFile.tab.c"
    break;

  case 21: /* val: varName  */
#line 112 "bisonFile.y"
              {
...
#line 1301 "bisonFile.tab.c"
    break;

  case 29: /* oneVar: varName '=' numberd  */
#line 164 "bisonFile.y"
                              {
                    if (find((yyvsp[-2].txt)) != -1) {
                        printf("Already declared: Variable %s \n", (yyvsp[-2].txt));
                    } 
...
#line 1320 "bisonFile.tab.c"
  ...
  case 30: /* variableValueAssign: varName '=' number EOL  */
...
#line 1340 "bisonFile.tab.c"
    break;

  case 31: /* variableValueAssign: varName '=' numberd EOL  */
#line 195 "bisonFile.y"
                                             {
                                        int i = find((yyvsp[-3].txt));
                                        if(i!=-1){
                                            if(!strcmp(symbolTable[i].type, "vogno")){
...
#line 1360 "bisonFile.tab.c"
    break;

  case 32: /* variableValueAssign: varName '=' expr EOL  */
#line 211 "bisonFile.y"
                                          {
                                        int i = find((yyvsp[-3].txt));
                                        if(i!=-1){
                                            if(!strcmp(symbolTable[i].type, "vogno")){
